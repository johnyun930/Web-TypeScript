...
function () {
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.attributes.getAll()).then(function (resposne) {
      _this.trigger('save');
    }).catch(function () {
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/User":"src/models/User.ts","./models/Collection":"src/models/Collection.ts"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
